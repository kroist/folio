...
Download **Folio 1.2.1 for Apple Silicon** from the [GitHub release](https://github.com/kroist/folio/releases/tag/v1.2.1). Open the DMG and drag Folio into Applications.

The 1.2.1 build is ad-hoc signed but not Apple-notarized. On first launch, macOS may require you to control-click Folio, choose **Open**, and confirm. Intel Macs are not supported by this build.

## Features

- A native-feeling three-pane Electron shell
- Ed25519-verified updates with release notes and restart controls
